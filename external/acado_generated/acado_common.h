...
/** Column vector of size: 690
 * 
 *  Lower bounds values for affine constraints.
 */
real_t lbAValues[ 690 ];

/** Column vector of size: 690
 * 
 *  Upper bounds values for affine constraints.
 */
real_t ubAValues[ 690 ];

/** Matrix of size: 30 x 9 (row major format) */
real_t mu[ 270 ];
...
{
/** Column vector of size: 4265 */
real_t rhs_aux[ 4265 ];

real_t rk_ttt;

/** Row vector of size: 229 */
real_t rk_xxx[ 229 ];

/** Matrix of size: 4 x 112 (row major format) */
real_t rk_kkk[ 448 ];

/** Row vector of size: 1728 */
real_t rk_sweep1[ 1728 ];
...
/** Matrix of size: 270 x 2 (row major format) */
real_t evGu[ 540 ];

/** Matrix of size: 330 x 11 (row major format) */
real_t EH[ 3630 ];
...
/** Column vector of size: 624 */
real_t conAuxVar[ 624 ];

/** Row vector of size: 33 */
real_t conValueIn[ 33 ];

/** Row vector of size: 301 */
real_t conValueOut[ 301 ];
...
/** Matrix of size: 450 x 2 (row major format) */
real_t evHu[ 900 ];
...
/** Matrix of size: 4185 x 2 (row major format) */
real_t E[ 8370 ];
...
/** Matrix of size: 690 x 60 (row major format) */
real_t A[ 41400 ];
